...
const TabsList = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.List> & { isActive?: boolean }
>(({ className, isActive: _isActive, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
...
const TabsContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Content> & { isActive?: boolean }
>(({ className, isActive: _isActive, ...props }, ref) => (
